...
3. Ik ____ graag een afspraak maken.
4. Mulan ____ een nieuwe hoofddoek?
5. Wij ____ graag ijs.
...
3. Wil je een ____ bij de koffie?
4. Wij krijgen een ____ docent.
5. De ____ is getrouwd: hij heeft een vrouw.
6. Mijn zus is ook mijn ____ .
7. De kleinkinderen komen morgen. Dat is ____ !
8. Wil je een ____ thee?
9. Zij praat een ____ Nederlands.
10. Ik wil me graag ____ . Ik ben Alex.
...
3. Twee woningen onder één dak is een ____ .
4. Een woning met boven, onder, links en rechts buren is een ____ .
5. Een woning met meestal maar één verdieping is een ____ .
6. Een woning die niet van jou is, is een ____ .
7. Een woning die wel van jou is, is een ____ .
8. Een woning in een rij is een ____ .
...
1. Kom (of: Voorstellen — zie let op)
2. thuis
3. koekje
4. nieuwe
5. buurman
...
Let op: `kom` en `voorstellen` passen allebei bij een begroeting/kennismaking. Zin 1 kan `Kom je zaterdag?` zijn; `voorstellen` past het beste bij zin 10 (`Ik wil me graag voorstellen.`).

### (4)

1. vrijstaand huis
2. twee-onder-een-kapwoning
